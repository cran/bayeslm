...
# horseshoe <- function(Y, X, penalize = NULL, block_vec = NULL, sigma = NULL, s2 = 1, kap2 = 1, N = 20000L, burnin = 0L, thinning = 1L, vglobal = 1, verb = FALSE, icept = FALSE, standardize = TRUE, singular = FALSE) {
...
bayeslm <- function(Y, X, prior = "horseshoe", penalize = NULL, block_vec = NULL, sigma = NULL, s2 = 1, kap2 = 1, N = 20000L, burnin = 0L, thinning = 1L, vglobal = 1, verb = FALSE, icept = FALSE, standardize = TRUE, singular = FALSE, prior_mean = NULL, prob_vec = NULL){
